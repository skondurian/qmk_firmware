...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_84(
        KC_ESC,         KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, BL_DOWN,  BL_UP,    KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  LCSG(KC_4), MO(3),      MO(1),
    ...
    [MAC_FN] = LAYOUT_ansi_84(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,  BL_TOGG,  _______,
        BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
    ...
    [WIN_BASE] = LAYOUT_ansi_84( // this I have not decided yet what to do with
        ...
        KC_1,     KC_2,     KC_3,     KC_4,     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
    ...
    [WIN_FN] = LAYOUT_ansi_84( // this layer is primarily for macros - for now to be set via Keychron Launcher or VIA dinamically
...
const key_override_t tilde_backtick_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_TILD, KC_GRAVE);


// This globally defines all key overrides to be used
const key_override_t *key_overrides[] = {
	&delete_key_override,
    &tilde_backtick_key_override
};
